...
```sh
npm i @taktikorg/dolores-recusandae-excepturi
```
...
```typescript
import { REGEX, SimpleRegexBuilder } from '@taktikorg/dolores-recusandae-excepturi';
```

#### CommonJS modules

```javascript
const { REGEX, SimpleRegexBuilder} = require('@taktikorg/dolores-recusandae-excepturi');
```
